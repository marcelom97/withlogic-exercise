...
ordered_arr = ['apple', 'banana', 'orange']

arr1 = ['banana', 'apple', 'orange', 'apps']
ordered_arr1 = ['apple', 'apps', 'banana', 'orange']


class InsertionSortTests(TestCase):
    def test_array(self):
        self.assertEqual(sort(arr), ordered_arr)
        self.assertEqual(sort(arr1), ordered_arr1)
...
class SortEndpointTests(APITestCase):
    ...
    def test_array_input(self):
        ...
        self.assertEqual(response.json(), ordered_arr)
